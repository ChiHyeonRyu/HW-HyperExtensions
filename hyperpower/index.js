  ...
  return class extends React.Component {
    ...
    _drawFrame () {
      ...
      this._particles.forEach((particle) => {
        ...
        this._canvasContext.fillRect(Math.round(particle.x - 1), Math.round(particle.y - 1), 50, 50);
        this._canvasContext.fillText('Chihyeon Ryu, OpenSource jjang jjang man', 40, 20);
      });
